  ...
  return (
    <div className="App">
      ...
      <section className="home" id="home">
        <h3>HAI FRIENDS !</h3>
        <h1>I'M <span>Ramchandra Rao</span></h1>
      </section>
      ...
      <section className="about" id="about">
        ...
        <div className="row">
          <div className="info">
            <h3> <span> Name : </span> Ramachandra Rao </h3>
            <h3> <span> Qualification : </span> B.Tech(pursuing) </h3>
            <h3> <span> Address</span> Hiramandalam, Srikakulam </h3>
      ...
      <section className="contact" id="contact">
        ...
        <div className="row">
          <div className="content">
            ...
            <div className="info">
              <h3> <i className="fas fa-envelope"></i> moningiramachandrarao@gmail.com </h3>
              <h3> <i className="fas fa-phone"></i> 9515278387 </h3>
              <h3> <i className="fas fa-map-marker-alt"></i> Hiramandalam, Srikakulam </h3>
            </div>
          </div>
        </div>
      </section>
